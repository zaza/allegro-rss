...
public class DoGetFavouriteCategoriesResponse  implements java.io.Serializable {
    private com.allegro.webapi.ArrayOfFavouritescategoriesstruct sFavouriteCategoriesList;

    public DoGetFavouriteCategoriesResponse() {
    }

    public DoGetFavouriteCategoriesResponse(
           com.allegro.webapi.ArrayOfFavouritescategoriesstruct sFavouriteCategoriesList) {
     ...
     */
    public com.allegro.webapi.ArrayOfFavouritescategoriesstruct getSFavouriteCategoriesList() {
        return sFavouriteCategoriesList;
    }
     ...
     */
    public void setSFavouriteCategoriesList(com.allegro.webapi.ArrayOfFavouritescategoriesstruct sFavouriteCategoriesList) {
        this.sFavouriteCategoriesList = sFavouriteCategoriesList;
    }
        ...
        _equals = true && 
            ((this.sFavouriteCategoriesList==null && other.getSFavouriteCategoriesList()==null) || 
             (this.sFavouriteCategoriesList!=null &&
              this.sFavouriteCategoriesList.equals(other.getSFavouriteCategoriesList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSFavouriteCategoriesList() != null) {
            _hashCode += getSFavouriteCategoriesList().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfFavouritescategoriesstruct"));
