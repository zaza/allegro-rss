...
public class DoMyBillingItemResponse  implements java.io.Serializable {
    private com.allegro.webapi.ArrayOfItembilling entryFees;

    private com.allegro.webapi.ArrayOfItembilling endingFees;

    public DoMyBillingItemResponse() {
    }

    public DoMyBillingItemResponse(
           com.allegro.webapi.ArrayOfItembilling entryFees,
           com.allegro.webapi.ArrayOfItembilling endingFees) {
     ...
     * @return entryFees
     */
    public com.allegro.webapi.ArrayOfItembilling getEntryFees() {
        return entryFees;
    }
     ...
     * @param entryFees
     */
    public void setEntryFees(com.allegro.webapi.ArrayOfItembilling entryFees) {
        this.entryFees = entryFees;
    }
     ...
     * @return endingFees
     */
    public com.allegro.webapi.ArrayOfItembilling getEndingFees() {
        return endingFees;
    }
     ...
     * @param endingFees
     */
    public void setEndingFees(com.allegro.webapi.ArrayOfItembilling endingFees) {
        this.endingFees = endingFees;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ((this.entryFees==null && other.getEntryFees()==null) || 
             (this.entryFees!=null &&
              this.entryFees.equals(other.getEntryFees()))) &&
            ((this.endingFees==null && other.getEndingFees()==null) || 
             (this.endingFees!=null &&
              this.endingFees.equals(other.getEndingFees())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getEntryFees() != null) {
            _hashCode += getEntryFees().hashCode();
        }
        if (getEndingFees() != null) {
            _hashCode += getEndingFees().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfItembilling"));
