...
public class DoGetMyIncomingPaymentsResponse  implements java.io.Serializable {
    private com.allegro.webapi.ArrayOfUserincomingpaymentstruct payTransIncome;

    public DoGetMyIncomingPaymentsResponse() {
    }

    public DoGetMyIncomingPaymentsResponse(
           com.allegro.webapi.ArrayOfUserincomingpaymentstruct payTransIncome) {
     ...
     */
    public com.allegro.webapi.ArrayOfUserincomingpaymentstruct getPayTransIncome() {
        return payTransIncome;
    }
     ...
     */
    public void setPayTransIncome(com.allegro.webapi.ArrayOfUserincomingpaymentstruct payTransIncome) {
        this.payTransIncome = payTransIncome;
    }
        ...
        _equals = true && 
            ((this.payTransIncome==null && other.getPayTransIncome()==null) || 
             (this.payTransIncome!=null &&
              this.payTransIncome.equals(other.getPayTransIncome())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPayTransIncome() != null) {
            _hashCode += getPayTransIncome().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfUserincomingpaymentstruct"));
