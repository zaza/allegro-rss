...
public class ArrayOfString  implements java.io.Serializable {
    ...
    /**
     * Gets the item value for this ArrayOfString.
     * 
     * @return item
     */
    ...
    /**
     * Sets the item value for this ArrayOfString.
     * 
     * @param item
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfString"));
