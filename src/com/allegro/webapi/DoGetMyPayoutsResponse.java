...
public class DoGetMyPayoutsResponse  implements java.io.Serializable {
    private com.allegro.webapi.ArrayOfUserpayoutstruct payTransPayout;

    public DoGetMyPayoutsResponse() {
    }

    public DoGetMyPayoutsResponse(
           com.allegro.webapi.ArrayOfUserpayoutstruct payTransPayout) {
     ...
     */
    public com.allegro.webapi.ArrayOfUserpayoutstruct getPayTransPayout() {
        return payTransPayout;
    }
     ...
     */
    public void setPayTransPayout(com.allegro.webapi.ArrayOfUserpayoutstruct payTransPayout) {
        this.payTransPayout = payTransPayout;
    }
        ...
        _equals = true && 
            ((this.payTransPayout==null && other.getPayTransPayout()==null) || 
             (this.payTransPayout!=null &&
              this.payTransPayout.equals(other.getPayTransPayout())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPayTransPayout() != null) {
            _hashCode += getPayTransPayout().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfUserpayoutstruct"));
