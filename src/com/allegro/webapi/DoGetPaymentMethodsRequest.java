/**
 * DoGetPaymentMethodsRequest.java
 *
...
public class DoGetPaymentMethodsRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the sessionId value for this DoGetPaymentMethodsRequest.
     * 
     * @return sessionId
     */
    ...
    /**
     * Sets the sessionId value for this DoGetPaymentMethodsRequest.
     * 
     * @param sessionId
     */
    ...
    /**
     * Gets the itemIds value for this DoGetPaymentMethodsRequest.
     * 
     * @return itemIds
     */
    ...
    /**
     * Sets the itemIds value for this DoGetPaymentMethodsRequest.
     * 
     * @param itemIds
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DoGetPaymentMethodsRequest)) return false;
        DoGetPaymentMethodsRequest other = (DoGetPaymentMethodsRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DoGetPaymentMethodsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", ">DoGetPaymentMethodsRequest"));
