...
public class ArrayOfInt  implements java.io.Serializable {
    ...
    /**
     * Gets the item value for this ArrayOfInt.
     * 
     * @return item
     */
    public int[] getItem() {
    ...
    /**
     * Sets the item value for this ArrayOfInt.
     * 
     * @param item
     */
    ...
    public void setItem(int i, int _value) {
        this.item[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfInt"));
