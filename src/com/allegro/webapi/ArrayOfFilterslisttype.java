...
public class ArrayOfFilterslisttype  implements java.io.Serializable {
    private com.allegro.webapi.FiltersListType[] item;

    public ArrayOfFilterslisttype() {
    }

    public ArrayOfFilterslisttype(
           com.allegro.webapi.FiltersListType[] item) {
           this.item = item;
    }
     ...
     * @return item
     */
    public com.allegro.webapi.FiltersListType[] getItem() {
        return item;
    }
     ...
     * @param item
     */
    public void setItem(com.allegro.webapi.FiltersListType[] item) {
        this.item = item;
    }

    public com.allegro.webapi.FiltersListType getItem(int i) {
        return this.item[i];
    }

    public void setItem(int i, com.allegro.webapi.FiltersListType _value) {
        this.item[i] = _value;
    }
