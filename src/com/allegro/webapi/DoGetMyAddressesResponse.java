...
public class DoGetMyAddressesResponse  implements java.io.Serializable {
    private com.allegro.webapi.ArrayOfAddressinfostruct addressesInfo;

    public DoGetMyAddressesResponse() {
    }

    public DoGetMyAddressesResponse(
           com.allegro.webapi.ArrayOfAddressinfostruct addressesInfo) {
     ...
     */
    public com.allegro.webapi.ArrayOfAddressinfostruct getAddressesInfo() {
        return addressesInfo;
    }
     ...
     * @param addressesInfo
     */
    public void setAddressesInfo(com.allegro.webapi.ArrayOfAddressinfostruct addressesInfo) {
        this.addressesInfo = addressesInfo;
    }
        ...
        _equals = true && 
            ((this.addressesInfo==null && other.getAddressesInfo()==null) || 
             (this.addressesInfo!=null &&
              this.addressesInfo.equals(other.getAddressesInfo())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getAddressesInfo() != null) {
            _hashCode += getAddressesInfo().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfAddressinfostruct"));
