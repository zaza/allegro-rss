...
public class DoGetStatesInfoResponse  implements java.io.Serializable {
    private com.allegro.webapi.ArrayOfStateinfostruct statesInfoArray;

    public DoGetStatesInfoResponse() {
    }

    public DoGetStatesInfoResponse(
           com.allegro.webapi.ArrayOfStateinfostruct statesInfoArray) {
     ...
     */
    public com.allegro.webapi.ArrayOfStateinfostruct getStatesInfoArray() {
        return statesInfoArray;
    }
     ...
     */
    public void setStatesInfoArray(com.allegro.webapi.ArrayOfStateinfostruct statesInfoArray) {
        this.statesInfoArray = statesInfoArray;
    }
        ...
        _equals = true && 
            ((this.statesInfoArray==null && other.getStatesInfoArray()==null) || 
             (this.statesInfoArray!=null &&
              this.statesInfoArray.equals(other.getStatesInfoArray())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getStatesInfoArray() != null) {
            _hashCode += getStatesInfoArray().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfStateinfostruct"));
