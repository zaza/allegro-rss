...
public class ArrayOfUserpostbuydatastruct  implements java.io.Serializable {
    private com.allegro.webapi.UserPostBuyDataStruct[] item;

    public ArrayOfUserpostbuydatastruct() {
    }

    public ArrayOfUserpostbuydatastruct(
           com.allegro.webapi.UserPostBuyDataStruct[] item) {
           this.item = item;
    }
     ...
     * @return item
     */
    public com.allegro.webapi.UserPostBuyDataStruct[] getItem() {
        return item;
    }
     ...
     * @param item
     */
    public void setItem(com.allegro.webapi.UserPostBuyDataStruct[] item) {
        this.item = item;
    }

    public com.allegro.webapi.UserPostBuyDataStruct getItem(int i) {
        return this.item[i];
    }

    public void setItem(int i, com.allegro.webapi.UserPostBuyDataStruct _value) {
        this.item[i] = _value;
    }
