...
public class DoGetSiteJournalInfoResponse  implements java.io.Serializable {
    private com.allegro.webapi.SiteJournalInfo siteJournalInfo;

    public DoGetSiteJournalInfoResponse() {
    }

    public DoGetSiteJournalInfoResponse(
           com.allegro.webapi.SiteJournalInfo siteJournalInfo) {
     ...
     */
    public com.allegro.webapi.SiteJournalInfo getSiteJournalInfo() {
        return siteJournalInfo;
    }
     ...
     */
    public void setSiteJournalInfo(com.allegro.webapi.SiteJournalInfo siteJournalInfo) {
        this.siteJournalInfo = siteJournalInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", ">doGetSiteJournalInfoResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("siteJournalInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "siteJournalInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "SiteJournalInfo"));
