/**
 * DoRemoveItemTemplatesRequest.java
 *
...
public class DoRemoveItemTemplatesRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the sessionId value for this DoRemoveItemTemplatesRequest.
     * 
     * @return sessionId
     */
    ...
    /**
     * Sets the sessionId value for this DoRemoveItemTemplatesRequest.
     * 
     * @param sessionId
     */
    ...
    /**
     * Gets the itemTemplateIds value for this DoRemoveItemTemplatesRequest.
     * 
    ...
    /**
     * Sets the itemTemplateIds value for this DoRemoveItemTemplatesRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DoRemoveItemTemplatesRequest)) return false;
        DoRemoveItemTemplatesRequest other = (DoRemoveItemTemplatesRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DoRemoveItemTemplatesRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", ">DoRemoveItemTemplatesRequest"));
